...
```{python}
import yaml
print("YAML module is working!")

```

```{python}
import nbclient
print("nbclient is installed and working!")
...
emissions_long["year"] = pd.to_numeric(emissions_long["year"], errors="coerce").astype("Int64")
...
selected_countries = ["Nigeria", "Brazil", "UK", "Greece", "Canada"]
...
fig_chart = px.line(emissions_long_subset, x="year", y="emissions", color="country", markers=True)
fig_chart
